                ...
                <form class="space-y-8 divide-y divide-gray-200">
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="col-span-2">
                            ...
                            <button type="button" x-on:click="open = false" wire:click="clearForm" class="bg-red-500 py-2 px-3 rounded-md shadow-sm text-sm hover:bg-red-800 font-medium text-white cursor-pointer">Fechar</button>
